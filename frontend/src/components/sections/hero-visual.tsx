  ...
  return (
    <div className="relative mx-auto w-full max-w-[28rem] lg:max-w-[32rem]">
      ...
      <div className="relative aspect-square overflow-hidden rounded-[2rem] p-6 sm:p-8">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_45%,rgba(244,162,97,0.12),transparent_38%),radial-gradient(circle_at_20%_20%,rgba(244,162,97,0.09),transparent_20%),radial-gradient(circle_at_80%_70%,rgba(244,162,97,0.06),transparent_22%)]" />
        ...
        >
          <defs>
            <linearGradient id="network-line" x1="0" x2="1" y1="0" y2="1">
              ...
              <stop offset="100%" stopColor="rgba(244,162,97,0.55)" />
            </linearGradient>
            <radialGradient id="node-glow" cx="50%" cy="50%" r="50%">
              <stop offset="0%" stopColor="rgba(244,162,97,0.95)" />
              <stop offset="100%" stopColor="rgba(244,162,97,0.1)" />
            </radialGradient>
          </defs>
          ...
          >
            <circle
              ...
              opacity="0.35"
            />
            <circle cx="210" cy="216" r="12" fill="rgba(244,162,97,0.92)" />
          </motion.g>
